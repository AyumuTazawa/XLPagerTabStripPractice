...
class ThirdViewController: UIViewController, IndicatorInfoProvider {
    ...
    func setupHud() {
        activityIndicatorView = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 60, height: 60), type: NVActivityIndicatorType.ballBeat, color: UIColor.blue, padding: 0)

...
class ThirdViewController: UIViewController, IndicatorInfoProvider {
    ...
    func setupHud() {
        activityIndicatorView = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 70, height: 70), type: NVActivityIndicatorType.ballBeat, color: UIColor.blue, padding: 0)
